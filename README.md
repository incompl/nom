...
It's important for visual design to emphasize your content and communicate your brand's personality. I went with a simple design with awesome food images that I found through [Flickr Creative Commons search](http://www.flickr.com/search/advanced/). The color scheme attempts to draw attention to important content while also communicating a trendy, modern vibe. I grabbed a background texture from [Subtle Patterns](http://subtlepatterns.com/) to match the more organic feel that the food images created. I'd want to have a more specialized designer take it to the next level for a commercial project, but I think this design gets the point across for this exercise.
